...
export class CryptoManager {
  constructor(masterKey) {
    ...
    this.key = crypto.pbkdf2Sync(masterKey, MASTER_KEY_SALT, MASTER_KEY_ITERATIONS, 32, "sha256");
    // Legacy SHA256 key — used only during startup migration of old encrypted secrets
    this.legacyKey = crypto.createHash("sha256").update(masterKey, "utf8").digest();
  }
